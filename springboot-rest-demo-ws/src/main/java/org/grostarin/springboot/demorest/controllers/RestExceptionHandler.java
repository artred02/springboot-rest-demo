...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(BookDeniedException.class)
    protected ResponseEntity<Object> handleDenied(Exception ex, WebRequest request) {
        return handleExceptionInternal(ex, "Book denied", new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
    }
